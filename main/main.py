...
def act_temp():
    ...
    sqlcommand = "INSERT INTO target_log (" + str(int(time.time()) + "," + target_temp + "," + targethigh + "," + targetlow + "," + hysteresis + ");"
    db.execute(sqlcommand)
    db.execute("INSERT INTO temps (? , ?);", str(int(time.time()), comp_temp) )
    db.commit()
